...
const MapView = (props) => {
    ...
    const [shortroute, setShortRoute] = useState([]);
    ...
    const calculateRoute = (userLat, userLng, hospitalLat, hospitalLng) => {
        ...
        fetch(osrmUrl)
            ...
            .then((data) => {
                ...
                setShortRoute(routeCoordinates);
            });
    };
    useEffect(() => {
        if (locations.length > 0) {
            calculateRoute(
                ...
                nearLoc.location.coordinates[1],
                nearLoc.location.coordinates[0]
            );
        }
    }, [locations]);
    ...
    return (
        ...
        >
            ...
            {shortroute.length > 0 && (
                <Polyline positions={shortroute} color="black" />
            )}
        </MapContainer>
    );
};
